...
call cmake.exe -DPROJECT_NAME="ndksample"^
			   -DANDROID_API=24^
			   -DARCH_ABI="armeabi-v7a"^
			   -DANDROID_MANIFEST="%ROOT_DIR%\android\AndroidManifest.xml"^
			   -DJAVA_DIRS="%ROOT_DIR%\android/java"^
			   -DRES_DIRS="%ROOT_DIR%\android\res"^
